...
const Animation: React.FC = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center bg-background-filter mt-2"
    >
      <div className="relative w-full max-w-9xl h-80 md:h-[32rem] text-white">
        <div className="relative w-full h-full">
          ...
          />
          <div className="absolute inset-0 bg-background-filter"></div>
        </div>
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 hidden md:flex">
          {slides.slice(0, 5).map((slide, index) => (
            <img
              ...
              src={slide.img}
              alt={slide.name}
              style={{ outline: "none", width: "100px", height: "100px" }}
